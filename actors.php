        ...
        <div class="container text-center">
            ...
            <nav>
                <form method="post">
                    ...
                    <strong><span id="Filter">Filter - </span> Name:</strong>  <input type="text" name="typedtext" placeholder="Actor/Actress Name" value="<?=$_GET['typedtext']?>"/>
                    <br>
            ...
            <?php
                ...
                echo "<tr>";
                echo "<strong><td class='actorlist'><a href=\"ainfo.php? firstName=".$result['firstName']. "&lastName=" .$result['lastName']. "&id=" .$result['actorID']."&dob=".
