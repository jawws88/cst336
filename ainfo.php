...
<html>
    <head>
        <title>JMDb: Actor/Actress Info</title>
        <style>
    ...
    <body>
        <div class="container text-center">
            ...
            <form method="post">
                <button class="btn btn-primary btn-sm"formaction="actors.php" type="submit">Back to Actors</button>
            </form>
        </div>
    </body>
</html>